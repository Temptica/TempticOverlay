...
public partial class FishSpawner : Node3D
{
    ...
    public override void _Ready()
    {
        ...
        ChatListener.Instance.StreamNewChatMessage += _ => { SpawnFish(); };
    }
    ...
    private void SpawnFish()
    {
        ...
        fish.CallDeferred("set_global_position",
            new Vector3((float)new Random().NextDouble() * 14 + 1, (float)new Random().NextDouble() * 7 + 1, 0));
        Fishes.Add(fish);
    }
